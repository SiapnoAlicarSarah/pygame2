...
class Game:
    def __init__(self):
        ...
        self.title_img = pygame.transform.scale(
            pygame.image.load("title.png").convert_alpha(),
            (700, 200)
        )
        ...
        self.easy_img = pygame.transform.scale(
            pygame.image.load("easy.png").convert_alpha(),
            (360, 95)
        )

        self.medium_img = pygame.transform.scale(
            pygame.image.load("medium.png").convert_alpha(),
            (360, 95)
        )

        self.hard_img = pygame.transform.scale(
            pygame.image.load("hard.png").convert_alpha(),
            (360, 95)
        )

        self.quit_img = pygame.transform.scale(
            pygame.image.load("quit.png").convert_alpha(),
            (360, 95)
        )

        self.select_img = pygame.transform.scale(
            pygame.image.load("select_difficulty.png").convert_alpha(),
            (400, 80)
        )
    ...
    def update(self, dt):
        ...
        if (
            self.gate is None
            and self.meters >= self.next_gate_meter
        ):
        ...
        if self.gate is not None:
            ...
            # Wait until gate reaches answer zone
